...
import com.example.bpregister.databinding.HeaderCardBinding
...
class ResultsAdapter(private val context: Context, private val bpDataList: List<BPItem>) : Adapter<ResultsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        if (viewType==TYPE_ITEM){
            ...
            return ViewHolder(HeaderCardBinding.inflate(LayoutInflater.from(parent.context), parent, false))
        }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if ( position ==0) {             //then it has to be a HeaderCardHolder with HeaderCardBinding
            val headerCardBinding = holder.binding as HeaderCardBinding
            ...
            val itemCardBinding  = holder.binding as ItemCardBinding
