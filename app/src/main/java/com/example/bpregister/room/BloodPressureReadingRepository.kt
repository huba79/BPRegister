...
//    lateinit var filteredRecords: Flow<List<BPEntity>>
    ...
    @WorkerThread
    suspend fun getFiltered(dateFrom:LocalDateTime?, dateTo:LocalDateTime?): Flow<List<BloodPressureReading>> {
