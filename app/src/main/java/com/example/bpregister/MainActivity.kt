...
class MainActivity : AppCompatActivity() {
    ...
    private fun resetCardData(){
        ...
        binding.datePickerButton.text= getString(R.string.date_visual_formatter, Calendar.YEAR, Calendar.MONTH + 1, Calendar.DAY_OF_MONTH) //getText(R.string.date_picker_button_caption)
        binding.timePickerButton.text=getString(R.string.time_visual_formatter,Calendar.HOUR_OF_DAY,Calendar.MINUTE)
    }
}